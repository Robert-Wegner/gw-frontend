...
class GalaxyMap extends React.Component {
   ...
   handleWheel(e) {
      ...
      const zoomFactor = Math.pow(1.0 + 100 / 600, 15);
      ...
      return(
         <div id = "galaxywrapper"  style = {{position: "relative"}}>
            ...
            <div style = {{position: "relative", left: frameDim.leftSize, top: frameDim.topSize}}>
               <img className="galaxy-background" src={imageAssets.background} alt="" width = {width - (frameDim.rightSize + frameDim.leftSize)} height = {height - (frameDim.bottomSize + frameDim.topSize)}/>
               <DragBox left = {this.state.leftShift} top = {this.state.topShift}
                        ...
                        content = { <div style = {{position: "absolute"}}>
                                       ...
                                       <div id="background" style = {{position: "absolute", backgroundColor: "rgba(0, 8, 12, 0.28)", width: mapWidth * mapScale, height: mapHeight * mapScale}} onWheel = {this.handleWheel}>
                                          {displayList}
                                       </div>
                                    </div>}
