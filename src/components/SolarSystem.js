      ...
      var statusContent = [];
         if (lobbyCount > 0) {
            statusContent.push(  <div style = {{height: "1em", width: "1em"}}>
                                    <img alt="Lobby" style = {{left: "0px", top: "0px", width: "100%", height: "100%"}} src = {imageAssets.lobby}/>
                                 </div>)
         ...
         if (battleCount > 0) {
            statusContent.push(  <div style = {{height: "1em", width: "1em"}}>
                                    <img alt="Battle" style = {{left: "0px", top: "0px", width: "100%", height: "100%"}} src = {imageAssets.battle}/>
                                 </div>)
            statusContent.push(  <div style = {{fontSize: "1em", lineHeight: "1em", color: "white"}}>
                                    {battleCount}
                                 </div>)
